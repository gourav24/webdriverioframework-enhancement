...
class dashboard {
    ...
    get textMenu() { return $(file.get('dashboard.selector.textMenu')); }
    get displayTextViewButton() { return $(file.get('dashboard.selector.displayTextViewButton')); }
    get nameTextBox() { return $(file.get('dashboard.selector.nameTextBox')); }
    get sendmeurNameButton() { return $(file.get('dashboard.selector.sendmeurNameButton')); }
    get chromeIconWebView() { return $(file.get('dashboard.selector.chromeIconWebView')); }
