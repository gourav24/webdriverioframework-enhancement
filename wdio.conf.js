...
exports.config = {
    ...
    capabilities: [
        ...
        }  */
        {
            ...
            app: './selendroid-test-app-0.11.0.apk',
            //app: './ContactManager.apk',
            //appPackage: 'com.toi.reader.activities',
            //appActivity: 'com.toi.reader.activities.NavigationFragmentActivity',
            // appPackage: 'com.anydo',
            // appActivity: 'com.anydo.mainlist.MainActivity',
    ...
    services: ['selenium-standalone', 'firefox-profile', 'iedriver', 'appium'],
    ...
    beforeFeature: function (feature) {
      //  Screen.prototype.open = function (path) {
       // browser.windowHandleMaximize()
        //browser.installApp('.\ApiDemos-debug.apk');
        //browser.startActivity('com.facebook.orca', 'com.facebook.messaging.accountlogin.AccountLoginActivity');
       // browser.startActivity('com.example.rh0116.myapplication', 'com.example.rh0116.myapplication.MainActivity');
        //browser.startActivity('io.appium.android.apis', 'io.appium.android.apis.ApiDemos');
        ///browser.startActivity('com.toi.reader.activities', 'com.toi.reader.activities.NavigationFragmentActivity');
       // browser.startActivity('com.android.calculator2', 'com.android.calculator2.Calculator');
      // browser.startActivity('com.android.vending', '.AssetBrowserActivity');
      //browser.startActivity('com.anydo', 'com.anydo.mainlist.MainActivity');
      
      browser.startActivity('io.selendroid.testapp', '.HomeScreenActivity');
