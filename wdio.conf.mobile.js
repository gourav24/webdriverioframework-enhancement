console.log("Running configuration file: wdio.conf.mobile.js");
...
exports.config = {
    ...
    services: ['selenium-standalone', 'firefox-profile', 'appium'],
    ...
    before: function (capabilities, specs) {
        ...
        mMyMTDCommissionLib = require('./pageFunctions/mMyMTDCommission.js')
        mLeaderboardLib = require('./pageFunctions/mLeaderboard.js')
        ...
        mMyMTDCommissionPage = require('./pageObjects/mMyMTDCommission.page.js')
        mLeaderboardPage = require('./pageObjects/mLeaderboard.page.js')
