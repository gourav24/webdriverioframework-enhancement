...
exports.config = {
    ...
    //
    specs: [
        './features/webFeatures/**/Reddit.feature'
    ...
    //'https://hsynlwsss101.amwaternp.net:8443/selfservice-web/login.do',
    //
    ...
    afterStep: function (stepResult) {
        ...
        browser.saveScreenshot('./screenshots/' + browser.desiredCapabilities.browserName + "-" + Date.now() + '.png');
